...
class EmailBrandingClient(NotifyAdminAPIClient):
    ...
    def create_email_branding(self, *, logo, name, alt_text, text, brand_type, created_by_id: str):
        data = {
            "logo": logo or None,
            "name": name,
    ...
    def update_email_branding(self, *, branding_id, logo, name, alt_text, text, brand_type, updated_by_id: str):
        data = {
            "logo": logo or None,
            "name": name,
            "alt_text": alt_text,
